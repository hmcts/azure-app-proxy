...
import {assignGroups, setUserAssignmentRequired} from "./servicePrincipalManager.js";
...
for await (const app of apps) {
    ...
    await assignGroups({token, objectId: servicePrincipalObjectId, groups: app.appRoleAssignments})
